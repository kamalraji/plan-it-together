...
export const ParticipantPortfolioPage: React.FC = () => {
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        if (queryError) {
          ...
          setProfile(data as PortfolioProfile);
        }
      } catch (err) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-cream via-background to-lavender/40 px-4 sm:px-6 lg:px-10 py-10">
      <section className="max-w-6xl mx-auto space-y-10">
        ...
        <header className="relative rounded-3xl border border-border/40 bg-gradient-to-br from-primary/10 via-background/80 to-accent/20 shadow-[0_24px_80px_rgba(15,23,42,0.45)] overflow-hidden">
          <div className="absolute inset-0 pointer-events-none opacity-40">
            ...
            <div className="absolute -bottom-32 -right-10 h-64 w-64 rounded-full bg-gradient-to-tr from-coral/50 to-teal/40 blur-3xl" />
          </div>
        ...
        {/* About & Highlights */}
        <section className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,1.1fr)] gap-6 lg:gap-8 items-start">
          {/* About */}
        ...
        {/* Future: Featured projects or event participation could surface here in a 3D card carousel */}
