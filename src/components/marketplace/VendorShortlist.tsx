                  ...
                  <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mb-3">
                          <div className="flex items-center">
                            ...
                            {service.vendors?.verification_status === 'verified' && (
                              <svg className="ml-1 w-4 h-4 text-success" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <button
                        ...
                        className="border border-destructive/40 text-destructive px-4 py-2 rounded-md hover:bg-destructive/10 transition-colors text-sm disabled:opacity-50"
                      >
