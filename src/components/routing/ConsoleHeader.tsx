...
interface ConsoleHeaderProps {
  ...
  /** Optional flag to hide the service switcher (used on org-specific dashboards). */
     ...
     <header className="bg-card border-b border-border fixed top-0 left-0 right-0 z-50 h-14 sm:h-16">
       <div className="flex items-center justify-between h-full px-3 sm:px-4 lg:px-6">
         ...
         <div className="flex items-center gap-3 sm:gap-4">
          ...
          {/* Service Switcher - visible only for organizer/admin roles when not explicitly hidden */}
