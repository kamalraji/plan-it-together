    ...
    return (
      <div className="bg-card border rounded-lg p-6">
        ...
        <div className="text-center py-8">
          <p className="text-muted-foreground">Integrated payment processing</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-card border rounded-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-muted/50 rounded-lg p-4">
          <h4 className="font-medium text-foreground mb-3">Vendor Contact Information</h4>
          
          <div className="space-y-2">
            <div className="flex items-center">
              <svg className="h-4 w-4 text-muted-foreground mr-2" fill="currentColor" viewBox="0 0 20 20">
