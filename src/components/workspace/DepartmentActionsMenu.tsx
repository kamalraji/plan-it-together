...
const departmentActions: Record<string, DepartmentAction[]> = {
  ...
  finance: [
    { id: 'budget-overview-finance', label: 'Budget Overview', icon: DollarSign, color: 'text-green-500', isTab: true },
    { id: 'expense-management-finance', label: 'Expense Management', icon: Receipt, color: 'text-blue-500', isTab: true },
    { id: 'invoice-management-finance', label: 'Invoice Management', icon: FileText, color: 'text-purple-500', isTab: true },
    { id: 'budget-approvals-finance', label: 'Budget Approvals', icon: ClipboardList, color: 'text-orange-500', isTab: true },
    { id: 'spending-analysis-finance', label: 'Spending Analysis', icon: PieChart, color: 'text-amber-500', isTab: true },
    ...
    { id: 'finance-audit-trail', label: 'Audit Trail', icon: FileSpreadsheet, color: 'text-indigo-500', isTab: true },
  ],
  growth: [
