...
const departmentActions: Record<string, DepartmentAction[]> = {
  ...
  finance: [
    ...
    { id: 'budget-approvals-finance', label: 'Budget Approvals', icon: ClipboardList, color: 'text-orange-500', isTab: true },
    ...
    { id: 'budget-forecast-finance', label: 'Budget Forecast', icon: TrendingUp, color: 'text-emerald-500', isTab: true },
