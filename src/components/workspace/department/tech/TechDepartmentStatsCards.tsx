  ...
  const stats = [
    {
      ...
      color: equipmentHealthRate >= 90 ? 'text-success' : equipmentHealthRate >= 70 ? 'text-warning' : 'text-destructive',
      bgColor: equipmentHealthRate >= 90 ? 'bg-success/10' : equipmentHealthRate >= 70 ? 'bg-warning/10' : 'bg-destructive/10',
    },
    {
      label: 'Task Progress',
    ...
    },
    {
      ...
      icon: AlertTriangle,
      color: criticalTasks > 0 ? 'text-destructive' : 'text-success',
      bgColor: criticalTasks > 0 ? 'bg-destructive/10' : 'bg-success/10',
    },
  ];
