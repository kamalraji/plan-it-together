        ...
        <header className="sticky top-0 z-20 border-b border-border/60 bg-background/80 backdrop-blur-md">
          <div className="container flex items-center justify-between py-4 gap-4">
            ...
            <div className="flex items-center gap-2">
              <Link
                to="/login"
                className="hidden sm:inline-flex text-sm font-medium text-muted-foreground hover:text-foreground min-h-[44px] items-center"
              >
                Sign in
              </Link>
              <Button
            ...
            <div className="container grid gap-10 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] items-start">
              ...
              <div className="grid gap-3 text-sm text-muted-foreground">
                <div className="rounded-2xl border border-border/60 bg-card/80 px-4 py-3 hover-scale hover-glow">
                  <p className="font-semibold text-foreground">Roles that match how you actually run events</p>
                ...
                <div className="rounded-2xl border border-border/60 bg-card/80 px-4 py-3 hover-scale hover-glow">
                  <p className="font-semibold text-foreground">Tasks that stay inside the event</p>
                  <p className="mt-1 text-xs text-muted-foreground">
                ...
                <div className="rounded-2xl border border-border/60 bg-card/80 px-4 py-3 hover-scale hover-glow">
                  <p className="font-semibold text-foreground">Access control that ends when the event does</p>
                  <p className="mt-1 text-xs text-muted-foreground">
          ...
          <section className="border-t border-border/60 bg-card/80 py-14 md:py-16">
            <div className="container max-w-3xl text-center space-y-4 hover-glow rounded-3xl border border-border/60 bg-card/90 px-6 py-10">
              ...
              <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
                Run your next fest, hackathon, or roadshow on Thittam1Hub, then roll the same verified flow across every
...
export default Thittam1HubLanding;
